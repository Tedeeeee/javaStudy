...
public class Main {
    public static void main(String[] args) {
        Click click1 = new Click(123, 456, 33221122);
        Click click2 = new Click(123, 456, 33221122);
        Click click3 = new Click(123, 456, 19293939);
        Click click4 = new Click(321, 534, 1231312313);
